...
| [`nutrient-dws`](plugins/nutrient-dws) | `make-pdf` | Generate PDFs from Markdown or HTML via DWS with accessible PDF/UA, archival PDF/A, and watermark output options |
